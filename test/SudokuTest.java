...
class SudokuTest {
    ...
    @Test
    public void myRun5 () throws FileNotFoundException {
        assertEquals(9083, run(5));
    }
    @Test
    public void myRun6 () throws FileNotFoundException {
        assertEquals(3, run(6));
    }

    @Test
    public void myRun7 () throws FileNotFoundException {
        Scanner s = new Scanner(new File("sudoku-board-7.txt"));
        Sudoku puzzle = Sudoku.read(s);
        System.out.printf("Input puzzle number %d:%n%s%n", 7, puzzle);
